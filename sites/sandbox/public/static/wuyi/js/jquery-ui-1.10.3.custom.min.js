...
(function(a, b, c) {
    ...
    var d, e, f, g, h, i = b.documentElement,
        j = !1,
        k, l, m = [];
...
jQuery(document).ready(function($) {
    $.fn.customFileInput = function(options) {
        ...
        var uploadButton = $('<span class="add-on customfile-button" aria-hidden="true">' + settings.button_text + '</span>').css({
            float: settings.button_position
        });
